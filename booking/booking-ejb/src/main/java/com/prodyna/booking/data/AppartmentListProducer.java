...
@RequestScoped
public class AppartmentListProducer {
	...
	public void onMemberListChanged(
			@Observes(notifyObserver = Reception.IF_EXISTS) final Appartment appartment) {
		retrieveAllAppartmentsOrderedByName();
	}

	@PostConstruct
	public void retrieveAllAppartmentsOrderedByName() {
		appartments = appartmentRepository.findAllOrderedByName();
	}
}
