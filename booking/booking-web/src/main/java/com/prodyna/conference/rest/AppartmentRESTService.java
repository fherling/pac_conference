...
@Path("/appartment")
@RequestScoped
public class AppartmentRESTService {
	@Inject
	private Logger log;
	...
	@Inject
	AppartmentRegistration registration;
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Appartment lookupAppartmentById(@PathParam("id") long id) {
		Appartment appartment = repository.findById(id);
		if (appartment == null) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Appartment deleteAppartmentById(@PathParam("id") long id) {
		Appartment appartment = repository.delete(id);
		if (appartment == null) {
			throw new WebApplicationException(Response.Status.NOT_FOUND);
		}
		return appartment;
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response createAppartment(Appartment appartment) {
		...
		try {
			...
			registration.register(appartment);
	...
	private void validate(Appartment appartment)
		...
		Set<ConstraintViolation<Appartment>> violations = validator
				.validate(appartment);
