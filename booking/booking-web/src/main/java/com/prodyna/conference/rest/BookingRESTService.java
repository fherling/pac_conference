...
public class BookingRESTService {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Booking lookupBookingById(@PathParam("id") long id) {
     ...
     * </p>
     * 
     * @param booking Member to be validated
    ...
    private void validateBooking(Booking booking) throws ConstraintViolationException, ValidationException {
        ...
        if (emailAlreadyExists(booking.getEmail())) {
    ...
    public boolean emailAlreadyExists(String email) {
        ...
        try {
            booking = repository.findByEmail(email);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Booking deleteBookingById(@PathParam("id") long id) {
	    Booking booking = repository.deleteById(id);
	    if (booking == null) {
	        throw new WebApplicationException(Response.Status.NOT_FOUND);
	    }
	    return booking;
