...
public class TalkRESTService implements Serializable {
	...
	private static final long serialVersionUID = 3714184871187409437L;
	...
	public List<TalkDTO> listAllRooms() {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public TalkDTO lookupRoomById(@PathParam("id") long id) {
		TalkDTO talk = service.findById(id);
		if (talk == null) {
